    ...
    public static void main(String[] args) throws MalformedURLException, NotBoundException, RemoteException {
        ...
        while ( ) {
            ...
            switch (elementColor) {
                case RED:
                case BLUE:
                    elementSorterHelper.moveGrabberToElement();
                    elementSorterHelper.grabElement();
                    elementSorterHelper.moveToBox1();
                    elementSorterHelper.openGrabber();
                    elementSorterHelper.moveSensorToElement();
                    break;
                case BLACK:
                case WHITE:
                case GRAY:
                    elementSorterHelper.moveGrabberToElement();
                    elementSorterHelper.grabElement();
                    elementSorterHelper.moveToBox2();
                    elementSorterHelper.openGrabber();
                    elementSorterHelper.moveSensorToElement();
                    break;
                case GREEN:
                default:
                    elementSorterHelper.moveGrabberToElement();
                    elementSorterHelper.grabElement();
                    elementSorterHelper.moveToBox3();
                    elementSorterHelper.openGrabber();
                    elementSorterHelper.moveSensorToElement();
                    break;
            }
